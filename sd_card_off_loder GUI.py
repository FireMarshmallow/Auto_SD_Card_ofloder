...
onbutton = tk.Button(top1, height=3, width=15, text="Start Scaning", command=switchon)
offbutton = tk.Button(top1, height=3, width=15, text="Stop scaning", command=switchoff)
killbutton = tk.Button(
    top1, height=3, width=15, text="EXIT", command=lambda: [kill(), switchoff()]
)
